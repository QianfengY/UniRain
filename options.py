...
parser.add_argument('--de_type', nargs='+', default=['drs', 'drd', 'nrs', 'nrd'],
...
parser.add_argument('--val_dir', type=str, default='data_dir/',  help='where clean images of denoising saves.')

parser.add_argument('--output_path', type=str, default="output/", help='output save path')
parser.add_argument('--ckpt_path', type=str, default="ckpt/", help='checkpoint save path')
parser.add_argument("--wblogger",type=str,default="",help = "Determine to log to wandb or not and the project name")
